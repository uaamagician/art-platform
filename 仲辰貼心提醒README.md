...
現在仍缺許多 分工的部分看要怎麼分配 介面設計的部分可能就要先麻煩冠呈跟喬琳 我們討論好就能先大概設計好就可以接上去了 程式的部分我個人認為可以有人來負責圖片上傳的資料庫 群組和聊天室跟私人聊天區可能也要有人做 然後篩選我想分一個大的標題是美術種類（素描、油畫、電繪）然後再分小標（＃我推的孩子 ＃有馬佳奈 等等） 評價設定 搜索設定（關聯性、評價）
